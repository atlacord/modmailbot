...
## Bot overview
Hawky is a ticketing system that lets users contact server staff through the bot instead of messaging staff members individually or pinging them publicly in the server.
...
To request access to your data or for your data to be deleted, please contact a server admin at https://discord.gg/avatar, or email [admin@atlacord.com](mailto:admin@atlacord.com)